<!--
  Source    : claude-skills / c-level-advisor/executive-mentor-stress-test/SKILL.md
...
---
name: "stress-test"
description: "/em:stress-test — Business assumption stress testing. Use before betting on a plan whose core assumptions are unvalidated — e.g. stress-testing 'enterprise buyers will tolerate a 6-month pilot' or a…"
---
