<!--
  Source    : claude-skills / ra-qm-team/capa-officer/SKILL.md
...
---
name: "capa-officer"
description: "CAPA system management for medical device QMS. Covers root cause analysis, corrective action planning, effectiveness verification, and CAPA metrics. Use when running CAPA investigations, 5-Why…"
metadata:
  category: "compliance"
  icon: "⚖️"
---
