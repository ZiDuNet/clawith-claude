<!--
  Source    : claude-skills / engineering/statistical-analyst/SKILL.md
...
description: "Run hypothesis tests, analyze A/B experiment results, calculate sample sizes, and interpret statistical significance with effect sizes. Use when you need to validate whether observed differences are…"
---
