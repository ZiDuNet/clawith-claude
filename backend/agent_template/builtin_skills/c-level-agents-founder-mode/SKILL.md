<!--
  Source    : claude-skills / c-level-advisor/c-level-agents-founder-mode/SKILL.md
...
---
name: "founder-mode"
description: "/cs:founder-mode <question> — Auto-routes any founder question to the right C-role advisor or to /cs:boardroom for multi-role topics. The single-command entry point. Use when a founder asks any…"
---
