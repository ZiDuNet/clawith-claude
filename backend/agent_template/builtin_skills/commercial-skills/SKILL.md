<!--
  Source    : claude-skills / commercial/commercial-skills/SKILL.md
  License   : MIT
  Domain    : commercial
...
description: "Use when reviewing, approving, or designing commercial motion — pricing models, deal review, discount approval, partnership economics, channel mix, commercial policy, RFP/RFI response, bookings…"
metadata:
  category: "commercial"
  icon: "💼"
---
