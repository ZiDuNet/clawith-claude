<!--
  Source    : claude-skills / c-level-advisor/c-level-agents-boardroom/SKILL.md
...
---
name: "boardroom"
description: "/cs:boardroom <brief> — 6-phase multi-role deliberation across the C-suite with Phase 2 isolation, critic pre-screen, and synthesis. Outputs a board memo. Use when a decision spans multiple executive…"
---
