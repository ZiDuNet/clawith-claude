<!--
  Source    : claude-skills / ra-qm-team/compliance-team-iso42001-iso42001-specialist/SKILL.md
  License   : MIT
  Domain    : ra-qm-team
  Adapted   : imported via scripts/import_claude_skills.py
-->

---
name: "iso42001-specialist"
description: "ISO/IEC 42001:2023 AI Management System (AIMS) specialist for compliance teams running internal audits. Three decisions: (1) Where are the gaps against Clauses 4-10 and what do we close first? (2)…"
metadata:
  category: "compliance"
  icon: "⚖️"
---

<!-- Upstream frontmatter (preserved for reference, not parsed):
     {
       "license": "MIT",
       "metadata": {
         "version": "1.0.0",
