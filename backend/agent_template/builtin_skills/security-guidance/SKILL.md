<!--
  Source    : claude-skills / engineering/security-guidance/SKILL.md
...
description: "PreToolUse security-anti-pattern hook for Claude Code. Catches 12 common security risks (command injection, XSS, SQL injection, unsafe deserialization, GitHub Actions workflow injection, eval/new…"
---
