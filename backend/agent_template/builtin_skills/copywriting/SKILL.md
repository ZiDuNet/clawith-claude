<!--
  Source    : claude-skills / marketing-skill/copywriting/SKILL.md
  License   : MIT
...
---
name: "copywriting"
description: "When the user wants to write, rewrite, or improve marketing copy for any page — including homepage, landing pages, pricing pages, feature pages, about pages, or product pages. Also use when the user…"
metadata:
  category: "marketing"
  icon: "📣"
---
