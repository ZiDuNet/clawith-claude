<!--
  Source    : claude-skills / research/syllabus/SKILL.md
  License   : MIT
  Domain    : research
...
---
name: "syllabus"
description: "Generates a curated supplementary reading list from any course syllabus using Consensus academic search. Grill-me intake (syllabus input format + course audience + year range) plus a grouping…"
metadata:
  category: "research"
  icon: "🔬"
---
