<!--
  Source    : claude-skills / c-level-advisor/decision-logger/SKILL.md
  License   : MIT
...
description: "Two-layer memory architecture for board meeting decisions. Manages raw transcripts (Layer 1) and approved decisions (Layer 2). Use when logging decisions after a board meeting, reviewing past…"
metadata:
  category: "c-level"
  icon: "👔"
---
