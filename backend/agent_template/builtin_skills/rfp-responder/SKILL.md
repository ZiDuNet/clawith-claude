<!--
  Source    : claude-skills / commercial/rfp-responder/SKILL.md
  License   : MIT
  Domain    : commercial
...
---
name: "rfp-responder"
description: "Use when an RFP, RFI, RFQ, security questionnaire, vendor questionnaire, or proposal request arrives and the team needs a structured response — parsing multi-section buyer-dictated requirements…"
metadata:
  category: "commercial"
  icon: "💼"
---
