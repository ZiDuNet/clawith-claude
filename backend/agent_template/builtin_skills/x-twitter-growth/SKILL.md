<!--
  Source    : claude-skills / marketing-skill/x-twitter-growth/SKILL.md
  License   : MIT
...
description: "X/Twitter growth engine for building audience, crafting viral content, and analyzing engagement. Use when the user wants to grow on X/Twitter, write tweets or threads, analyze their X profile,…"
metadata:
  category: "marketing"
  icon: "📣"
---
