<!--
  Source    : claude-skills / c-level-advisor/c-level-agents-onboard/SKILL.md
...
---
name: "onboard"
description: "/cs:onboard — Founder interview that populates ~/.claude/company-context.md using the canonical 7-dimension cs-onboard schema. The first command to run when starting with c-level-agents. Use when…"
---
