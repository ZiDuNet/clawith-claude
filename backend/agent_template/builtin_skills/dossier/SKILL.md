<!--
  Source    : claude-skills / research/dossier/SKILL.md
  License   : MIT
  Domain    : research
...
---
name: "dossier"
description: "Decision-grade entity research skill — produces a hypothesis-tested dossier on a specific company, person, nonprofit, or government org, not a generic profile. Forcing intake makes the user state…"
metadata:
  category: "research"
  icon: "🔬"
---
