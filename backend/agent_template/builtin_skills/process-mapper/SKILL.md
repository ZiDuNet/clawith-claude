<!--
  Source    : claude-skills / business-operations/process-mapper/SKILL.md
  License   : MIT
...
---
name: "process-mapper"
description: "Use when a BizOps lead, COO, or process-improvement owner needs to document an end-to-end business process (procurement, employee onboarding, incident handoff, customer-onboarding, claims…"
metadata:
  category: "operations"
  icon: "⚙️"
---
