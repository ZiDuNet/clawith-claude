<!--
  Source    : claude-skills / engineering/docker-development/SKILL.md
  License   : MIT
  Domain    : engineering
...
description: "Docker and container development agent skill and plugin for Dockerfile optimization, docker-compose orchestration, multi-stage builds, and container security hardening. Use when: user wants to…"
metadata:
