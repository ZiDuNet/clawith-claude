<!--
  Source    : claude-skills / engineering-team/adversarial-reviewer/SKILL.md
  License   : MIT
...
description: "Adversarial code review that breaks the self-review monoculture. Use when you want a genuinely critical review of recent changes, before merging a PR, or when you suspect Claude is being too…"
metadata:
