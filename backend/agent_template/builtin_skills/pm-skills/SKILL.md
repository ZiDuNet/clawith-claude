<!--
  Source    : claude-skills / project-management/pm-skills/SKILL.md
  License   : MIT
...
---
name: "pm-skills"
description: "Router/index for the 8 project-management skills bundled in this plugin (senior PM quant toolkit, scrum master, Jira/JQL, Confluence, Atlassian admin, Atlassian templates, meeting analyzer, team…"
metadata:
  category: "operations"
  icon: "⚙️"
---
