<!--
  Source    : claude-skills / engineering-team/senior-backend/SKILL.md
...
---
name: "senior-backend"
description: "Designs and implements backend systems including REST APIs, microservices, database architectures, authentication flows, and security hardening. Use when the user asks to "design REST APIs",…"
---
