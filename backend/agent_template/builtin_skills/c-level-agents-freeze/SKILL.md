<!--
  Source    : claude-skills / c-level-advisor/c-level-agents-freeze/SKILL.md
...
---
name: "freeze"
description: "/cs:freeze <decision> <days> — Lock a strategic decision for a cooldown period to prevent impulse reversal. Mirrors gstack's safety primitives for the business layer. Use when an irreversible…"
---
