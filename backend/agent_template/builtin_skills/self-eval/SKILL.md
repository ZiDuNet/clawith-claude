<!--
  Source    : claude-skills / engineering/self-eval/SKILL.md
  License   : MIT
  Domain    : engineering
...
---
name: "self-eval"
description: "Honestly evaluate AI work quality using a two-axis scoring system. Use after completing a task, code review, or work session to get an unbiased assessment. Detects score inflation, forces devil's…"
metadata:
