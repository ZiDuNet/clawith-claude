<!--
  Source    : claude-skills / c-level-advisor/context-engine/SKILL.md
  License   : MIT
...
---
name: "context-engine"
description: "Loads and manages company context for all C-suite advisor skills. Reads ~/.claude/company-context.md, detects stale context (>90 days), enriches context during conversations, and enforces…"
metadata:
  category: "c-level"
  icon: "👔"
---
