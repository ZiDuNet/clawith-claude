<!--
  Source    : claude-skills / marketing-skill/social-media-manager/SKILL.md
  License   : MIT
...
description: "When the user wants to develop social media strategy, plan content calendars, manage community engagement, or grow their social presence across platforms. Also use when the user mentions 'social…"
metadata:
  category: "marketing"
  icon: "📣"
---
