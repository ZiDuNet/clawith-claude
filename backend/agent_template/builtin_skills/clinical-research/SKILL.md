<!--
  Source    : claude-skills / research-ops/clinical-research/SKILL.md
  License   : MIT
  Domain    : research-ops
...
description: "Use when designing a prospective clinical study before submission — selecting and classifying endpoints (primary / key-secondary / exploratory, with surrogate-endpoint flagging), estimating sample…"
metadata:
  category: "research"
  icon: "🔬"
---
