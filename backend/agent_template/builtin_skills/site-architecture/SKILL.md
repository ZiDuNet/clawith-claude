<!--
  Source    : claude-skills / marketing-skill/site-architecture/SKILL.md
  License   : MIT
...
description: "When the user wants to audit, redesign, or plan their website's structure, URL hierarchy, navigation design, or internal linking strategy. Use when the user mentions 'site architecture,' 'URL…"
metadata:
  category: "marketing"
  icon: "📣"
---
