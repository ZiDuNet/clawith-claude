<!--
  Source    : claude-skills / productivity/handoff/SKILL.md
  License   : MIT
  Domain    : productivity
...
---
name: "handoff"
description: "Compact the current conversation into a handoff document for another agent to pick up. Save to a user-configured location (OS temp, home folder, or per-project .handoff/), redact secrets before…"
metadata:
