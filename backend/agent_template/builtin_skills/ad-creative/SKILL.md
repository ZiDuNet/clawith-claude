<!--
  Source    : claude-skills / marketing-skill/ad-creative/SKILL.md
  License   : MIT
...
---
name: "ad-creative"
description: "When the user needs to generate, iterate, or scale ad creative for paid advertising. Use when they say 'write ad copy,' 'generate headlines,' 'create ad variations,' 'bulk creative,' 'iterate on…"
metadata:
  category: "marketing"
  icon: "📣"
---
