<!--
  Source    : claude-skills / commercial/deal-desk/SKILL.md
  License   : MIT
  Domain    : commercial
...
---
name: "deal-desk"
description: "Use when reviewing a specific inbound deal before close — when sales has asked for a discount that exceeds AE authority, when the customer has redlined the MSA, when per-deal economics (margin after…"
metadata:
  category: "commercial"
  icon: "💼"
---
