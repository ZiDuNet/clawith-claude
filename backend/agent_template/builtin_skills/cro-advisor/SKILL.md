<!--
  Source    : claude-skills / c-level-advisor/cro-advisor/SKILL.md
  License   : MIT
...
---
name: "cro-advisor"
description: "Revenue leadership for B2B SaaS companies. Revenue forecasting, sales model design, pricing strategy, net revenue retention, and sales team scaling. Use when designing the revenue engine, setting…"
metadata:
  category: "c-level"
  icon: "👔"
---
