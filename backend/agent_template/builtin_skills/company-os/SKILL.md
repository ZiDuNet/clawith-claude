<!--
  Source    : claude-skills / c-level-advisor/company-os/SKILL.md
  License   : MIT
...
---
name: "company-os"
description: "The meta-framework for how a company runs — the connective tissue between all C-suite roles. Covers operating system selection (EOS, Scaling Up, OKR-native, hybrid), accountability charts,…"
metadata:
  category: "c-level"
  icon: "👔"
---
