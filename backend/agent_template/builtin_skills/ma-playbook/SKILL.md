<!--
  Source    : claude-skills / c-level-advisor/ma-playbook/SKILL.md
  License   : MIT
...
---
name: "ma-playbook"
description: "M&A strategy for acquiring companies or being acquired. Due diligence, valuation, integration, and deal structure. Use when evaluating acquisitions, preparing for acquisition, M&A due diligence,…"
metadata:
  category: "c-level"
  icon: "👔"
---
