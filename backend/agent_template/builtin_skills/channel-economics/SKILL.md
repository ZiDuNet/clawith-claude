<!--
  Source    : claude-skills / commercial/channel-economics/SKILL.md
  License   : MIT
  Domain    : commercial
...
description: "Use when reviewing or rebalancing direct vs. partner-led channel economics — computing fully-loaded cost-to-serve per channel, channel ROI with cash / LTV / marginal lenses, and optimal channel mix…"
metadata:
  category: "commercial"
  icon: "💼"
---
