<!--
  Source    : claude-skills / c-level-advisor/change-management/SKILL.md
  License   : MIT
...
description: "Framework for rolling out organizational changes without chaos. Covers the ADKAR model adapted for startups, communication templates, resistance patterns, and change fatigue management. Handles…"
metadata:
  category: "c-level"
  icon: "👔"
---
