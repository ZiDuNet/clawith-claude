<!--
  Source    : claude-skills / engineering/feature-flags-architect/SKILL.md
  License   : MIT
  Domain    : engineering
...
description: "Use when adding, retiring, or auditing feature flags. Triggers on "add a flag", "ship behind a flag", "rollout plan", "kill switch", "stale flags", "flag debt", "LaunchDarkly", "GrowthBook",…"
---
