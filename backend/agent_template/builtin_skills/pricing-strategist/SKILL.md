<!--
  Source    : claude-skills / commercial/pricing-strategist/SKILL.md
  License   : MIT
  Domain    : commercial
...
description: "Use when designing or revisiting product pricing — selecting a pricing model (subscription seat-based, usage-based, value-based, freemium, or hybrid), running Van Westendorp Price Sensitivity Meter…"
metadata:
  category: "commercial"
  icon: "💼"
---
