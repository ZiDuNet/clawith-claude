<!--
  Source    : claude-skills / marketing-skill/prompt-engineer-toolkit/SKILL.md
  License   : MIT
...
description: "Turns marketing prompts into tested, versioned production assets: A/B prompt evaluation against structured test cases, immutable prompt version history with diffs, ready-to-use marketing prompt…"
metadata:
  category: "marketing"
  icon: "📣"
---
