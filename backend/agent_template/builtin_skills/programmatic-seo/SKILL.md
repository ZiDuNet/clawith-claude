<!--
  Source    : claude-skills / marketing-skill/programmatic-seo/SKILL.md
  License   : MIT
...
description: "When the user wants to create SEO-driven pages at scale using templates and data. Also use when the user mentions "programmatic SEO," "template pages," "pages at scale," "directory pages," "location…"
---
