<!--
  Source    : claude-skills / product-team/code-to-prd/SKILL.md
  License   : MIT
  Domain    : product-team
...
---
name: "code-to-prd"
description: "Reverse-engineer any codebase into a complete Product Requirements Document (PRD). Analyzes routes, components, state management, API integrations, and user interactions to produce business-readable…"
metadata:
  category: "product"
  icon: "📦"
---
