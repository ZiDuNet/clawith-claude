<!--
  Source    : claude-skills / engineering-team/senior-architect/SKILL.md
...
description: "This skill should be used when the user asks to "design system architecture", "evaluate microservices vs monolith", "create architecture diagrams", "analyze dependencies", "choose a database", "plan…"
---
