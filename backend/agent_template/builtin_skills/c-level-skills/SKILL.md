<!--
  Source    : claude-skills / c-level-advisor/c-level-skills/SKILL.md
  License   : MIT
...
---
name: "c-level-skills"
description: "Index and router for the C-level advisory bundle: 33 skills covering 14 C-suite roles, orchestration, cross-cutting capabilities, and culture. Use when exploring what the c-level-advisor bundle…"
metadata:
  category: "c-level"
  icon: "👔"
---
