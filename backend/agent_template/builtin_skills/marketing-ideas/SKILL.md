<!--
  Source    : claude-skills / marketing-skill/marketing-ideas/SKILL.md
  License   : MIT
...
description: "When the user needs marketing ideas, inspiration, or strategies for their SaaS or software product. Also use when the user asks for 'marketing ideas,' 'growth ideas,' 'how to market,' 'marketing…"
metadata:
  category: "marketing"
  icon: "📣"
---
