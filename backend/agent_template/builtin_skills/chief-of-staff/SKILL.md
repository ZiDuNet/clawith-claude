<!--
  Source    : claude-skills / c-level-advisor/chief-of-staff/SKILL.md
  License   : MIT
...
---
name: "chief-of-staff"
description: "C-suite orchestration layer. Routes founder questions to the right advisor role(s), triggers multi-role board meetings for complex decisions, synthesizes outputs, and tracks decisions. Every C-suite…"
metadata:
  category: "c-level"
  icon: "👔"
---
