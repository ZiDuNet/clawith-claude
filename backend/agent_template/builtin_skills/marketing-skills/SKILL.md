<!--
  Source    : claude-skills / marketing-skill/marketing-skills/SKILL.md
  License   : MIT
...
description: "Directory and router for the marketing skills library. Use when you need to find the right marketing skill for a task, see what marketing capabilities exist, or get oriented in this plugin. 44…"
metadata:
  category: "marketing"
  icon: "📣"
---
