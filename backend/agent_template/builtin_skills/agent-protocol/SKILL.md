<!--
  Source    : claude-skills / c-level-advisor/agent-protocol/SKILL.md
  License   : MIT
...
---
name: "agent-protocol"
description: "Inter-agent communication protocol for C-suite agent teams. Defines invocation syntax, loop prevention, isolation rules, and response formats. Use when C-suite agents need to query each other,…"
metadata:
  category: "c-level"
  icon: "👔"
---
