<!--
  Source    : claude-skills / engineering/ship-gate/SKILL.md
  License   : MIT
  Domain    : engineering
...
---
name: "ship-gate"
description: "Pre-production audit that scans a codebase for security, database, deployment, code quality, AI/LLM, dependency, frontend, and observability issues. Intercepts deploy commands and blocks until…"
metadata:
