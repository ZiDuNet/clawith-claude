<!--
  Source    : claude-skills / marketing-skill/campaign-analytics/SKILL.md
  License   : MIT
...
description: "Analyzes campaign performance with multi-touch attribution, funnel conversion analysis, and ROI calculation for marketing optimization. Use when analyzing marketing campaigns, ad performance,…"
metadata:
  category: "marketing"
  icon: "📣"
---
