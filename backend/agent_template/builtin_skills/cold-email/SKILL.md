<!--
  Source    : claude-skills / marketing-skill/cold-email/SKILL.md
  License   : MIT
...
---
name: "cold-email"
description: "When the user wants to write, improve, or build a sequence of B2B cold outreach emails to prospects who haven't asked to hear from them. Use when the user mentions 'cold email,' 'cold outreach,'…"
metadata:
  category: "marketing"
  icon: "📣"
---
