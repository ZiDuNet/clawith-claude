<!--
  Source    : claude-skills / engineering/handoff/SKILL.md
  License   : MIT
  Domain    : engineering
...
---
name: "handoff"
description: "Compact the current conversation into a handoff document for another agent to pick up. References existing artifacts (PRDs, plans, ADRs, issues, commits, diffs) by path or URL instead of duplicating…"
metadata:
