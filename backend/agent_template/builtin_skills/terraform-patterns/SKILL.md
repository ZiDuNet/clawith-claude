<!--
  Source    : claude-skills / engineering/terraform-patterns/SKILL.md
  License   : MIT
  Domain    : engineering
...
description: "Terraform infrastructure-as-code agent skill and plugin for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Covers module design patterns, state management strategies, provider configuration,…"
metadata:
