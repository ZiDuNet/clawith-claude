<!--
  Source    : claude-skills / marketing-skill/youtube-full/SKILL.md
  License   : MIT
...
---
name: "youtube-full"
description: "Use when the user needs YouTube transcripts, video search, channel browsing, playlist extraction, or content monitoring. Trigger phrases: 'get the transcript for', 'search YouTube for', 'what are the…"
metadata:
  category: "marketing"
  icon: "📣"
---
