<!--
  Source    : claude-skills / engineering-team/epic-design/SKILL.md
  License   : MIT
...
---
name: "epic-design"
description: "Build immersive, cinematic 2.5D interactive websites using scroll storytelling, parallax depth, text animations, and premium scroll effects — no WebGL required. Use this skill for any web design…"
metadata:
