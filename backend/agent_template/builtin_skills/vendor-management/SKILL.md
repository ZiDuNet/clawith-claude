<!--
  Source    : claude-skills / business-operations/vendor-management/SKILL.md
  License   : MIT
...
description: "Use when reviewing, scoring, or auditing third-party SaaS / vendor relationships — running a vendor scorecard with industry tuning, tracking SLA compliance with credit-claim flags, classifying…"
metadata:
  category: "operations"
  icon: "⚙️"
---
