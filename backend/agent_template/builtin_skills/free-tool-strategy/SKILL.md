<!--
  Source    : claude-skills / marketing-skill/free-tool-strategy/SKILL.md
  License   : MIT
...
description: "When the user wants to build a free tool for marketing — lead generation, SEO value, or brand awareness. Use when they mention 'engineering as marketing,' 'free tool,' 'calculator,' 'generator,'…"
metadata:
  category: "marketing"
  icon: "📣"
---
