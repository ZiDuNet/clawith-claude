<!--
  Source    : claude-skills / c-level-advisor/cto-advisor/SKILL.md
  License   : MIT
...
---
name: "cto-advisor"
description: "Technical leadership guidance for engineering teams, architecture decisions, and technology strategy. Use when assessing technical debt, scaling engineering teams, evaluating technologies, making…"
metadata:
  category: "c-level"
  icon: "👔"
---
