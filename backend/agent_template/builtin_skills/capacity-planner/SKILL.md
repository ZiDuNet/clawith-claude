<!--
  Source    : claude-skills / business-operations/capacity-planner/SKILL.md
  License   : MIT
...
description: "Use when an ops leader (Director of CX, Head of Support, VP Ops, Head of BizOps, Head of IT ops, Head of Finance ops) is sizing ops capacity, building a headcount plan, modeling utilization risk,…"
metadata:
  category: "operations"
  icon: "⚙️"
---
