<!--
  Source    : claude-skills / marketing-skill/marketing-psychology/SKILL.md
  License   : MIT
...
description: "When the user wants to apply psychological principles, mental models, or behavioral science to marketing. Also use when the user mentions 'psychology,' 'mental models,' 'cognitive bias,'…"
metadata:
  category: "marketing"
  icon: "📣"
---
