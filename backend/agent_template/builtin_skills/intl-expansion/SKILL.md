<!--
  Source    : claude-skills / c-level-advisor/intl-expansion/SKILL.md
  License   : MIT
...
---
name: "intl-expansion"
description: "International market expansion strategy. Market selection, entry modes, localization, regulatory compliance, and go-to-market by region. Use when expanding to new countries, evaluating international…"
metadata:
  category: "c-level"
  icon: "👔"
---
