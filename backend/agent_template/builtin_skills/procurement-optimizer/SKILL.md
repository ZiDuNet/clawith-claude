<!--
  Source    : claude-skills / business-operations/procurement-optimizer/SKILL.md
  License   : MIT
...
description: "Use when running an annual SaaS audit, doing category-level spend review, or rationalizing the supplier base — when the user needs a spend audit, spend categorization (UNSPSC-aligned with Pareto…"
metadata:
  category: "operations"
  icon: "⚙️"
---
