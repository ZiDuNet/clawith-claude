<!--
  Source    : claude-skills / c-level-advisor/ciso-advisor/SKILL.md
  License   : MIT
...
---
name: "ciso-advisor"
description: "Security leadership for growth-stage companies. Risk quantification in dollars, compliance roadmap (SOC 2/ISO 27001/HIPAA/GDPR), security architecture strategy, incident response leadership, and…"
metadata:
  category: "c-level"
  icon: "👔"
---
