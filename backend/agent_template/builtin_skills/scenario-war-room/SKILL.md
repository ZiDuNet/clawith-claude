<!--
  Source    : claude-skills / c-level-advisor/scenario-war-room/SKILL.md
  License   : MIT
...
description: "Cross-functional what-if modeling for cascading multi-variable scenarios. Unlike single-assumption stress testing, this models compound adversity across all business functions simultaneously. Use…"
metadata:
  category: "c-level"
  icon: "👔"
---
