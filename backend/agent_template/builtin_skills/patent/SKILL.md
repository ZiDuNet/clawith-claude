<!--
  Source    : claude-skills / research/patent/SKILL.md
  License   : MIT
  Domain    : research
...
---
name: "patent"
description: "Patent prior-art and landscape intelligence skill — not generic patent help. Commits to one of five sub-use-cases via forcing intake (novelty search / freedom-to-operate / competitive landscape /…"
metadata:
  category: "research"
  icon: "🔬"
---
